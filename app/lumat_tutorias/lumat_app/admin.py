...
def admin_calendario_generar_pdf_view(request):
    ...
    if request.method == "POST":
        ...
        if not seminarios_db:
            messages.error(
                request,
                "No hay seminarios registrados en la base de "
        ...
        # 2. 🔀 ALEATORIEDAD EN LAS PERSONAS:
        #        Mezclamos la lista de seminarios directamente
        ...
        for i, seminario in enumerate(seminarios_db):
            # Suma días consecutivamente: el primero se queda el día de
            # inicio, el segundo al día siguiente...
        ...
        # Al ir en orden i=0,1,2 ya quedan ordenados
        # cronológicamente por defecto
