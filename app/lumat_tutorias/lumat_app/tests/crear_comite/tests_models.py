...
class CrearComiteTestCase(TestCase):
    def setUp(self):
        ...
        # NUEVO: Creamos 3 usuarios base requeridos por la base de datos para los docentes
        user_d1 = User.objects.create_user(username='docente_test1', password='123')
        user_d2 = User.objects.create_user(username='docente_test2', password='123')
        user_d3 = User.objects.create_user(username='docente_test3', password='123')

        # 2. Docentes necesarios para crear el comité asignando el campo 'user'
    ...
    def test_crear_comite_falla_por_docentes_repetidos(self):
        """No se debe permitir crear un comité si hay docentes duplicados en los roles."""
        comite = Comite(
            tutor=self.docente_a,
        ...
        with self.assertRaisesMessage(ValidationError, "Los tres docentes del comité deben ser distintos."):
            comite.save()
    ...
    def test_superusuario_puede_crear_comite(self):
        """El superusuario tiene permisos para enviar el formulario de creación."""
    ...
    def test_usuario_normal_rechazado_al_crear_comite(self):
        """Un usuario sin privilegios no puede procesar la petición de creación."""
