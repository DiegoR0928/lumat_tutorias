...
class FiltrarPorBusquedaTest(BaseFiltrosTest):
    ...
    def test_filtrar_por_matricula(self):
        ...
        self.assertEqual(resultado[0]['seminario'].alumno.matricula, "20220001")
    
    def test_filtrar_sin_resultados(self):
        como_tutor, como_miembro = self._get_querysets()
        resultado = _filtrar_por_busqueda(como_tutor, como_miembro, "MATRICULA_INEXISTENTE")
...
class FiltrarPorRolYEstadoTest(BaseFiltrosTest):
    ...
    def test_filtrar_por_rol_tutor(self):
        como_tutor, como_miembro = self._get_querysets()
        resultado = _filtrar_por_rol_y_estado(como_tutor, como_miembro, 'tutor', 'todos')
    ...
    def test_filtrar_por_rol_miembro(self):
        ...
        como_tutor, como_miembro = self._get_querysets()
        resultado = _filtrar_por_rol_y_estado(como_tutor, como_miembro, 'miembro', 'todos')
    ...
    def test_filtrar_por_rol_todos(self):
        ...
        como_tutor, como_miembro = self._get_querysets()
        resultado = _filtrar_por_rol_y_estado(como_tutor, como_miembro, 'todos', 'todos')
    ...
    def test_filtrar_por_estado_completados(self):
        como_tutor, como_miembro = self._get_querysets()
        resultado = _filtrar_por_rol_y_estado(como_tutor, como_miembro, 'todos', 'completados')
    ...
    def test_filtrar_por_estado_pendientes(self):
        como_tutor, como_miembro = self._get_querysets()
        resultado = _filtrar_por_rol_y_estado(como_tutor, como_miembro, 'todos', 'pendientes')
