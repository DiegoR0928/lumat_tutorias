...
urlpatterns = [
    ...
    path('docente/registro/', views_docente.registro_docente, name='registro_docente'),
    path('docente/registro/pendiente/', views_docente.registro_docente_pendiente, name='registro_docente_pendiente'),
    path('docente/activar/<uidb64>/<token>/', views_docente.activar_docente, name='activar_docente'),
    path('docente/seminarios/', views_docente.docente_seminarios,
         name='docente_seminarios'),
    path('docente/perfil/', views_docente.editar_perfil_docente,
         name='perfil_docente'),
    ...
    path('alumno/seminario/<int:num>/acta/',
